const Map<String, String> be = {
  ...
  'seconds': 'Секунды: ',
  'timer': 'Таймер: ',
  'clipLength': 'Даўжыня кліпа',
  'countdown': 'Зваротны адлік',
  'countdownHint': 'Чакаць 3 секунды перад пачаткам запісу',
  'dateFormat': 'Фармат даты:',
  'dateColor': 'Колер даты:',
  'selectColor': 'Выберыце колер',
  'textOutline': 'Кантрасная абводка',
  'textOutlineHint':
      'Дадае абводку супрацьлеглага колеру, каб тэкст заставаўся чытэльным (рэкамендуецца)',
  ...
  'landscapeHint': 'Ідэальна для ТБ і камп’ютараў',
  'portraitHint': 'Ідэальна для тэлефонаў і сторыс',
  'cameraMicPermissionTitle': 'Доступ да камеры і мікрафона',
  'cameraMicPermissionDesc':
      'One Second Diary патрэбныя камера і мікрафон, каб запісаць ваш момант дня.',
  'cameraPermissionTitle': 'Доступ да камеры',
  'cameraPermissionDesc':
      'One Second Diary патрэбная камера, каб запісаць ваш момант дня.',
  'permissionSettingsHint':
      'Доступ для гэтай праграмы адключаны. Яго можна зноў уключыць у наладах прылады.',
  'allowAccess': 'Дазволіць доступ',
  ...
  'strictClipLength': 'Строгая працягласць кліпа',
  'strictClipLengthDescription':
      'Па змаўчанні да захаванага кліпа дадаецца дадатковая паўсекунды звыш вашага выбару абразання (напрыклад, выбар у 1 секунду захоўваецца як 1,5 секунды). Уключыце гэта, каб захоўваць менавіта тую працягласць, якую вы выбіраеце.',
  'verboseLogging': 'Падрабязнае журналяванне',
  'verboseLoggingDescription':
      'Запісвае дадатковыя дыягнастычныя звесткі, каб дапамагчы ў вырашэнні памылак. Звярніце ўвагу, што гэтыя дадатковыя запісы могуць змяшчаць асабістую інфармацыю.',
};
