const Map<String, String> zh = {
  ...
  'clipLength': '片段时长',
  'countdown': '倒计时',
  'countdownHint': '开始录制前等待 3 秒',
  'dateFormat': '日期格式:',
  'dateColor': '日期颜色:',
  'selectColor': '选择颜色',
  'textOutline': '对比描边',
  'textOutlineHint': '添加相反颜色的边框，让文字保持清晰可读（推荐）',
  ...
  'landscapeHint': '适合电视和电脑',
  'portraitHint': '适合手机和短视频',
  'cameraMicPermissionTitle': '相机和麦克风权限',
  'cameraMicPermissionDesc': 'One Second Diary 需要使用您的相机和麦克风来记录您每天的瞬间。',
  'cameraPermissionTitle': '相机权限',
  'cameraPermissionDesc': 'One Second Diary 需要使用您的相机来记录您每天的瞬间。',
  'permissionSettingsHint': '此应用的访问权限已关闭。您可以在设备设置中重新开启。',
  'allowAccess': '允许访问',
  'openSettings': '打开设置',
  'notNow': '以后再说',
